...
- How does subscription type affect churn?  
...
- Premium plan users churn less than basic plan users.  
- High monthly charges do not always predict churn.

## 🚀 Next Steps
- Build a predictive model for churn (e.g., logistic regression or tree-based models)  
